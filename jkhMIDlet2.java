...
public class jkhMIDlet extends MIDlet implements CommandListener, ItemStateListener {
    ...
    public void startApp() {
        ...
        fC = new ChoiceGroup (null, Choice.MULTIPLE);
        fC.append("Расчет", null);
        form.append (fP1);
        form.append (fP2);
        form.append (fP3);
        form.append (fP4);
    ...
    public void itemStateChanged(Item item) {
        if (item == fC) commandAction (calcCommand, null);
        fC.setSelectedIndex (0, false);
    }
